...
# Our password comes from a kubernetes secret. This secret file isn't available during build.
# "Kubectl create secret geoserver-data --from-literal=geoserver_adminpw=...."
#
# ${geoserver_adminpw}
...
PWD_HASH=$(make_hash $geoserver_adminpw)
