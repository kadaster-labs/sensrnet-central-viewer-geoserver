...
# Add context.xml to conf/context.xml. This addition is required in order to correctly include the local-postgresql name
...
COPY build_src/config/datastore.template.xml ${APP_FILES}/datastore.template.xml
